(function(factory){
  ...
  $.extend(true,$.summernote.lang,{
      'en-US':{ /* English */
          math:{
              dialogTitle:'Inserir Matematica',
              tooltip:'Inserir Matematica',
              pluginTitle:'Inserir Matematica',
              ok:'Inserir',
              cancel:'Cancelar'
          }
      }
      ...
      'math':function(context){
          ...
          self.initialize = function(){
              ...
              let body=`<div class="form-group">
                  ...
                  <p>Tipo <a href="https://khan.github.io/KaTeX/function-support.html" target=_blank">marcação LaTeX</a> here: </p>
